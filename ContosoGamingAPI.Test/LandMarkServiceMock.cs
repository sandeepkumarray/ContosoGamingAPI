...
{
    class LandMarkServiceMock : ILandMarkService
    {
        ...
        {
            var existing = _dbContext.LandMarks.Any(x => x.Id == id) ? _dbContext.LandMarks.First(a => a.Id == id) : null;
        ...
        {
            return _dbContext.LandMarks.Any(x => x.Id == id) ? _dbContext.LandMarks.First(x => x.Id == id) : null;
        }
